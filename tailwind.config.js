...
const defaultTheme = {
  ...
  extend: {
    ...
    colors: {
      ...
      "forensic-sealed": "var(--color-forensic-sealed)",
      "forensic-sealed-bg": "var(--color-forensic-sealed-bg)",
      "forensic-sealed-border": "var(--color-forensic-sealed-border)",
      "forensic-sealed-text": "var(--color-forensic-sealed-text)",
      "forensic-condition": "var(--color-forensic-condition)",
      "forensic-condition-bg": "var(--color-forensic-condition-bg)",
      "forensic-condition-border": "var(--color-forensic-condition-border)",
      "forensic-condition-text": "var(--color-forensic-condition-text)",
      "forensic-error": "var(--color-forensic-error)",
      "forensic-error-bg": "var(--color-forensic-error-bg)",
      "forensic-error-border": "var(--color-forensic-error-border)",
      "forensic-error-text": "var(--color-forensic-error-text)",
      "forensic-info": "var(--color-forensic-info)",
      "forensic-info-bg": "var(--color-forensic-info-bg)",
      "forensic-info-border": "var(--color-forensic-info-border)",
      "forensic-info-text": "var(--color-forensic-info-text)",
    },
    borderRadius: {
      sm: "var(--radius-sm)",
      md: "var(--radius-md)",
